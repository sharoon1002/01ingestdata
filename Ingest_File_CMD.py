...
def uploadfile(Year,Month,remquotes):
    ...
    if os.path.exists(csvfile):
        ...
        client = storage.Client.from_service_account_json("My Project 40276-d203c8401ab2.json") # This file is created from GCP Service account and require when run on local machine.
